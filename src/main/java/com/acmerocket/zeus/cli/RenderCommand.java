...
import com.acmerocket.zeus.ZeusConfiguration;
...
public class RenderCommand extends ConfiguredCommand<ZeusConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<ZeusConfiguration> bootstrap,
                       Namespace namespace,
                       ZeusConfiguration configuration) throws Exception {
